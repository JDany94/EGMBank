    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="top-navbar-1">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="indexsecundario.php" ><i class="fa fa-mail-reply"></i><br>Volver</a>
                </li>                           
                <li>
        ...
        <div class="row text-center">
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    ...
                    <a class="big-link-1" href="rotransferenciassec.php">Transferir</a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    ...
                    <h3>Prestamos</h3>
                    <a class="big-link-1" href="roprestamossec.php">Solicitar</a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    ...
                    <a class="big-link-1" href="rotdcsec.php">Consultar</a>
                </div>
            </div> 
        </div>
    </div> 
