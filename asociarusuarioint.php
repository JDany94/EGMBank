    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="top-navbar-1">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="administrarusuariosint.php" ><i class="fa fa-mail-reply"></i><br>Volver</a>
                </li>                           
                <li>
        ...
        <div class="row text-center">
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    ...
                    <h3>Personalizado</h3>
                    <a class="big-link-1" href="asociarusuariopersonalizadoint.php">Asociar</a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    ...
                    <h3>Roles</h3>
                    <a class="big-link-1" href="asociarusuariorolesint.php">Asociar</a>
                </div>
            </div>
