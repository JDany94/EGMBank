        ...
        <div class="col-sm-5">
            <div class="page-title-container">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <font color="black" size="3">Niveles para las aprobaciones de los usuarios:</font>
                        </div><br><br>
                        <div class="col-sm-12">
                        <select>
                            <option>Nivel de aprobacion jerarquico</option>
                            <option>Nivel de aprobacion paralelo</option>
                            </select>
                        </div><br><br>
                        <div class="col-sm-3">
