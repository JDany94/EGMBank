        ...
        <div class="container">
            ...
            <div class="col-md-12"></div>
                <div class="col-sm-12 wow fadeIn">
                    ...
                    <h1>Bienvenida, Jessica Smith!</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row text-center">
            ...
            <div class="col-sm-4">
                <div class="service wow fadeInUp">
                    ...
                    <a class="big-link-1" href="realizaroperaciones.php">Operaciones</a>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="service wow fadeInUp">
                    ...
                    <h3>Aprobaciones</h3>
                    <a class="big-link-1" href="aprobaciones.php">Ver Mas</a>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="service wow fadeInUp">
                    ...
                    <a class="big-link-1" href="administrarusuarios.php">Ver Mas</a>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="service wow fadeInUp">
                    ...
                    <a class="big-link-1" href="solicitudenlinea.php">Ver Mas</a>
                </div>
            </div>            
        </div>
    </div> 
