        ...
        <div class="container">
            ...
            <div class="col-md-12"></div>
                <div class="col-sm-12 wow fadeIn">
                    ...
                    <h1>Asociar Usuario por Roles</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-sm-5">
            <div class="page-title-container">
                <div class="container">
                    <div class="row">
                    <form role="form" method="post" action="controladores/alertacrearusuario.php">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <font color="black" size="3">Roles:</font>
                            <select>
                            <option>Administrador Basico</option>
                            <option>Administrador Medio</option>
                            <option>Administrador Completo</option>
                            <option>Secundario Basico</option>
                            <option>Secundario Medio</option>
