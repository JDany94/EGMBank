                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <option>Jorgue Moutinho - JM</option>
                            </select>
                        </div><br><br>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text"  placeholder="23640762" onKeyPress="return soloNumeros(event);">
                        </div><br><br>  
                        <div class="col-sm-12">
                            <font color="black" size="3">Usuario:</font>
                            <input type="text" name="res" placeholder="JD">
                        </div><br><br>
                        <div class="col-sm-12">
                            <font color="black" size="3">Nombre:</font>
                            <input type="text" name="res" placeholder="Daniel" onKeyPress="return soloLetras(event);">
                        </div><br><br>
                        <div class="col-sm-12">
                            <font color="black" size="3">Apellido:</font>
                            <input type="text" name="res" placeholder="Fuentes" onKeyPress="return soloLetras(event);">
                        </div><br><br>
                        <div class="col-sm-12">
                            <font color="black" size="3">Email:</font>
                            <input type="text" name="res" placeholder="jdf@gmail.com">
                        </div><br><br>
                        <div class="col-sm-12">
                            <font color="black" size="3">Telefono:</font>
                            <input type="text" name="res" placeholder="04149394041" onKeyPress="return soloNumeros(event);">
                        </div><br><br>
                        <div class="col-sm-4"> 
                        ...
                        <div class="col-sm-12">
                        <a class="btn btn-default" onclick='alert("Usuario guardado exitosamente!")' href="javascript:history.back(-1);">Editar</a>
                        </div>
                    </div>
                </div>
            </div>
