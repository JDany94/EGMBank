        ...
        <div class="container">
            ...
            <div class="col-md-12"></div>
                <div class="col-sm-12 wow fadeIn">
                    ...
                    <h1>Transferencias mismo Usuario</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-sm-9">
            <div class="page-title-container">
                <div class="container">
                    <div class="row">
                    <form role="form" method="post" action="controladores/alertatransferencias.php">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <font color="black" size="3">Cuenta a Transferir:</font>
                            <select>
                            <option>Ahorro</option>
                            <option>Corriente</option>
                            </select>
                        ...
                        <div class="col-sm-9"><font color="black" size="3">Ingrese las Coordenadas:</font><br></div>
                        <div class="col-sm-3"></div>
                        <div class="col-sm-2">
